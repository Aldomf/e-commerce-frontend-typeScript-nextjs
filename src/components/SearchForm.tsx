  ...
  return (
    <form className="max-w-lg mx-auto">
      <div className="relative w-full">
        ...
        <button
          type="submit"
          className="absolute top-0 end-0 p-2.5 w-12 text-sm font-medium h-full text-white bg-white rounded-r-full border border-white hover:bg-white focus:ring-4 focus:outline-none focus:ring-white dark:bg-white dark:hover:bg-white dark:focus:ring-whibg-white"
        >
