...
function AdminUser() {
  ...
  const updateOrderStatus = async (id: number, status: OrderStatus) => {
    try {
      const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6InRlc3RAdGVzdC5jb20iLCJ1c2VybmFtZSI6IkFsZG8iLCJzdWIiOjEsInJvbGUiOiJhZG1pbiIsImlhdCI6MTcxMDc5MzAxMywiZXhwIjoxNzEwNzk2NjEzfQ.QVcL6jgCHCoKKFSHfiT9TWuIjJ7Vyp6fpB-KPIDO4qA";
